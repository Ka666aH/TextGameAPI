namespace TextGame.Domain.GameText
{
    public static class EnemiesLabeles
    {
        ...
        public const string GhostName = "ПРИЗРАК";
        public const string GhostDescription = "Злой полуматериальный дух. Попробуй попади.";
        public const string LichName = "ЛИЧ";
        public const string LichDescription = "Тебя ждёт вечный параЛИЧ. Ха-ха.";
