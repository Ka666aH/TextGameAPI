...
namespace TextGame.Application.Interfaces.Services
{
    ...
    {
        Task<string> NewGameSessionAsync(Guid userId, CancellationToken ct = default);
        ...
        Task<List<GameSession>> GetGameSessions(Guid userId, CancellationToken ct = default);
    }
}